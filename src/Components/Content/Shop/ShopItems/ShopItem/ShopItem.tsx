...
const App: React.FunctionComponent<IAppProps> = ({
  ...
  return (
    <div
      ...
      onMouseEnter={() =>
        setpictureOptions({ imageVisbility: true, picture: content.image })
      }
      onMouseLeave={() =>
        setpictureOptions({ imageVisbility: false, picture: content.image })
      }
    >
      <div className="ItemName">{content.name}</div>
      <div className="ItemBuyOptionsContainer">
        <div>{content.prince}$</div>
        <div className="cartIcon" onClick={addItemToCarthandler}>
          <svg
            viewBox="0 0 24 24"
            width="18px"
            height="18px"
